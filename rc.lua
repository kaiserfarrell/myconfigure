...
r.run("clipit")
r.run("nautilus")
r.run("nm-connection-editor")
r.run("gnome-terminal")
r.run("urxvtd -q -o -f")
...
-- {{{ Tags
 ...
 tags = {
   names  = { "Kaiser_Farrell", "Home", "Hacker", "Work", "Programmer", "Study", "Scan"},
   layout = { layouts[5], layouts[1], layouts[1], layouts[1],layouts[1], layouts[1],layouts[1], 
 }}
